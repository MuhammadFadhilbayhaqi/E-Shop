        ...
        Card(
            ...
            Column(
                ...
                OutlinedTextField(
                    ...
                    label = { Text(text = stringResource(id = R.string.harga_beli)) },
                    maxLines = 1,
                    keyboardOptions = KeyboardOptions(
                ...
                OutlinedTextField(
                    ...
                    label = { Text(text = stringResource(id = R.string.harga_jual)) },
                    maxLines = 1,
                    keyboardOptions = KeyboardOptions(
                        keyboardType = KeyboardType.Number,
                        imeAction = ImeAction.Next
                ...
                Row(
                    ...
                    OutlinedButton(
                        onClick = { onConfirmation(namabarang, hargabeli, hargajual, stok, keterangan) },
                        enabled = namabarang.isNotEmpty() && hargabeli.isNotEmpty() && hargajual.isNotEmpty() && stok.isNotEmpty() && keterangan.isNotEmpty(),
                        modifier = Modifier.padding(8.dp)
                    ) {
